...
""")
    ...
    system = {
        ...
        "content": f"You are Local Coder, an autonomous AI agent with coding AND computer use abilities. Working directory: {CWD}\n"
                   ...
                   f"STATIC TEMPLATES (copy from templates/static/ and customize):\n"
                   f"- quiz-game/index.html: Interactive quiz with SVG visuals, score, confetti, sound. Replace CARDS/questions.\n"
                   f"- flashcards/index.html: Flip-card study app. Replace CARDS array with content.\n"
                   f"- gallery/index.html: Image gallery with masonry grid + lightbox. Replace images and captions.\n"
                   f"To use: read_file the template, then write_file a customized version. Replace {{TITLE}}, {{ICON}}, etc.\n"
